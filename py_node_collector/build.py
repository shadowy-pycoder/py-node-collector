# python build stubs for package collector
...
mod = Module('_collector')
mod.add_include('"collector_go.h"')
...
mod.add_function('collector_NodeCollector_CTor', retval('int64_t'), [])
add_checked_string_function(mod, 'collector_Collect', retval('char*'), [])

mod.generate(open('collector.c', 'w'))
